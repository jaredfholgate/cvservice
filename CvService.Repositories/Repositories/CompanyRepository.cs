...
namespace CvService.Repositories.Repositories
{
  public class CompanyRepository : ICompanyRepository
  {
    ...
    {
      var cv = _cvContext.Cvs.Include(c => c.Companies).Single(o => o.Id == cvId);
    ...
    {
      return _cvContext.Companies.Include(o => o.Cv).Where(o => o.Cv.Id == cvId).OrderByDescending(o => o.Start).ToList();
    }

    public Company Get(int id)
    {
      return _cvContext.Companies.Include(o => o.Cv).Single(o => o.Id == id);
    }
